...
module.exports = {
  // Using CSS variable-based theming — no Tailwind dark mode needed
  // Dark/light mode handled via .light class on <html> + CSS custom properties
  darkMode: false,
  ...
  theme: {
    extend: {
      colors: {
        ...
        orange: { 400: '#ffa530', 500: '#f7931a', 600: '#e07d0a' },
