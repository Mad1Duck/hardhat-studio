import { bS as createAssigner, bT as isPrototype, bh as isArrayLike, bC as copyObject, bl as assignValue, bi as isArray, aD as baseRest, aE as isArrayLikeObject, bs as baseAssignValue, bv as isObjectLike, bw as baseGetTag, bt as baseUnary, bH as nodeUtil, aG as isFunction, aH as isEmpty, bj as identity, bd as isObject, aL as commonjsGlobal, bU as getAugmentedNamespace, bV as __vitePreload } from "./index-C5W5dauG.js";
import { k as keys, j as baseEach, g as baseIteratee, S as SetCache, w as arrayIncludes, x as cacheHas, c as baseFlatten, v as values, y as baseIndexOf, l as arrayMap, z as getAllKeysIn, A as arrayFilter, B as baseFilter, C as arraySome, a as baseUniq, d as forEach, i as isUndefined, r as reduce, f as filter, D as noop } from "./_baseUniq-Cl_TODZH.js";
import { j as toInteger, m as map, d as basePickBy, f as flatten, g as find, h as has, i as defaults, l as last, e as min } from "./_basePickBy-CRrmk0mA.js";
import { c as clone } from "./clone-Bo-dL_rb.js";
...
(function(Diagnostic2) {
  ...
  function is2(value) {
    var _a2;
    let candidate = value;
    return Is$5.defined(candidate) && Range.is(candidate.range) && Is$5.string(candidate.message) && (Is$5.number(candidate.severity) || Is$5.undefined(candidate.severity)) && (Is$5.integer(candidate.code) || Is$5.string(candidate.code) || Is$5.undefined(candidate.code)) && (Is$5.undefined(candidate.codeDescription) || Is$5.string((_a2 = candidate.codeDescription) === null || _a2 === void 0 ? void 0 : _a2.href)) && (Is$5.string(candidate.source) || Is$5.undefined(candidate.source)) && (Is$5.undefined(candidate.relatedInformation) || Is$5.typedArray(candidate.relatedInformation, DiagnosticRelatedInformation.is));
  }
  Diagnostic2.is = is2;
